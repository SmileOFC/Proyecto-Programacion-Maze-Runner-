public class Tablero
{
    ...
    public static int[,] LaberintoCopy = new int[
        Tablero.laberinto.GetLength(0),
        Tablero.laberinto.GetLength(1)
    ];
    public static bool[,] NieblaCopy = new bool[
        Tablero.niebla.GetLength(0),
        Tablero.niebla.GetLength(1)
    ];
    public static bool[,] PunteroCopy = new bool[
        Tablero.Puntero.GetLength(0),
        Tablero.Puntero.GetLength(1)
    ];
    ...
    public static void GenerarTablero()
    {
        ...
        laberinto[11, 14] = 1;
        laberinto[12, 14] = 1;
        laberinto[13, 14] = 1111;
        laberinto[14, 14] = 1111;
        laberinto[15, 14] = 1111;
        laberinto[16, 14] = 1111;
        laberinto[17, 14] = 1111;
        laberinto[18, 14] = 1;
        laberinto[19, 14] = 1;
        ...
        laberinto[11, 14] = 1;
        laberinto[12, 16] = 1;
        laberinto[13, 16] = 1111;
        laberinto[14, 16] = 1111;
        laberinto[15, 16] = 1111;
        laberinto[16, 16] = 1111;
        laberinto[17, 16] = 1111;
        laberinto[18, 16] = 1;
        laberinto[19, 14] = 1;
